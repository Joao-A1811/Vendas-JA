...
| Campo | Valor |
|---|---|
| Formato | E-book (arquivo PDF) |
| Categoria | Saúde e esportes / Finanças / Desenvolvimento pessoal (ver por produto) |
| Preço Brasil | **R$ 47,00** |
| Preço internacional (EN/ES) | **US$ 19** (criar oferta em dólar pro mesmo produto) |
| Garantia | **7 dias** |
| Página de vendas | usar a URL da página do produto no site (campo "página de vendas externa") |
| Arquivo entregue | o PDF do idioma da compra (subir os 3 PDFs quando existirem) |

> Dica: dá pra cadastrar UM produto por nicho e criar **ofertas** separadas (BRL e USD).
> O link de checkout de cada oferta é o que vai no `linkCheckoutHotmart` da página
> correspondente (PT recebe o link BRL; EN e ES recebem o link USD).

> Importante (linha ética + políticas): as descrições abaixo já estão dentro das regras —
> sem promessa numérica de peso/corpo, sem rentabilidade garantida, sem papo de manipulação.
> Se for editar, mantenha essa linha.

---

## 1. Emagrecimento — categoria: Saúde e esportes

**Nome (PT):** Emagrecimento Inteligente — Guia Prático NextLevel
**Descrição (PT):**
Um método prático de hábitos e alimentação consciente pra emagrecer de forma leve — sem dieta
radical, sem terrorismo nutricional e sem abrir mão da sua vida social. Você vai aprender a
montar refeições que saciam e cabem no seu bolso, criar uma rotina realista mesmo com pouco
tempo (sem depender de academia) e, principalmente, construir constância: o que fazer quando
sair da linha pra voltar no dia seguinte sem jogar tudo fora. E-book digital com acesso
imediato e garantia incondicional de 7 dias. Conteúdo educacional — não substitui
acompanhamento médico ou nutricional.

**Name (EN):** Smart Weight Loss — NextLevel Practical Guide
**Description (EN):**
A practical method of habits and mindful eating to lose weight the light way — no radical
diets, no food terrorism, and no giving up your social life. Learn to build satisfying,
affordable meals, create a realistic routine even with little time (no gym required) and,
above all, build consistency: what to do when you slip so you get back on track the next day.
Digital ebook, instant access, 7-day unconditional guarantee. Educational content — not a
substitute for medical or nutritional care.

**Nombre (ES):** Pérdida de Peso Inteligente — Guía Práctica NextLevel
**Descripción (ES):**
Un método práctico de hábitos y alimentación consciente para adelgazar de forma ligera — sin
dietas radicales, sin terrorismo alimentario y sin renunciar a tu vida social. Aprenderás a
montar comidas que sacian y caben en tu bolsillo, crear una rutina realista aunque tengas poco
tiempo (sin depender del gimnasio) y, sobre todo, construir constancia: qué hacer cuando te
salgas del plan para volver al día siguiente. Ebook digital, acceso inmediato y garantía
incondicional de 7 días. Contenido educativo — no sustituye el acompañamiento médico o
nutricional.

---

## 2. Ganho de Massa — categoria: Saúde e esportes

**Nome (PT):** Ganho de Massa Inteligente — Guia Prático NextLevel
**Descrição (PT):**
Treino, alimentação e descanso organizados num plano simples pra construir músculo com método,
não com achismo. Você vai entender séries, progressão de carga e técnica explicadas de forma
simples; como montar pratos acessíveis com proteína suficiente sem suplemento milagroso; e o
papel do sono e da recuperação — o que quase todo iniciante ignora. Serve pra treinar em casa
ou na academia. E-book digital com acesso imediato e garantia incondicional de 7 dias.
Conteúdo educacional — não substitui acompanhamento profissional.

**Name (EN):** Smart Muscle Gain — NextLevel Practical Guide
**Description (EN):**
Training, food and rest organized into one simple plan to build muscle with method, not
guesswork. Understand sets, progressive overload and technique explained simply; how to build
affordable, protein-sufficient meals without miracle supplements; and the role of sleep and
recovery — what almost every beginner ignores. Works for home or gym training. Digital ebook,
instant access, 7-day unconditional guarantee. Educational content — not a substitute for
professional supervision.

**Nombre (ES):** Ganancia Muscular Inteligente — Guía Práctica NextLevel
**Descripción (ES):**
Entrenamiento, comida y descanso organizados en un plan simple para construir músculo con
método, no con suposiciones. Entenderás series, progresión de carga y técnica explicadas de
forma simple; cómo montar platos económicos con proteína suficiente sin suplementos
milagrosos; y el papel del sueño y la recuperación — lo que casi todo principiante ignora.
Sirve para entrenar en casa o en el gimnasio. Ebook digital, acceso inmediato y garantía
incondicional de 7 días. Contenido educativo — no sustituye la supervisión profesional.

---

## 3. Investimentos — categoria: Finanças e negócios

**Nome (PT):** Investimentos do Zero — Guia Prático NextLevel
**Descrição (PT):**
O passo a passo pra sair do zero nos investimentos, sem economês: organizar o orçamento e as
dívidas antes de investir o primeiro real, montar a reserva de emergência do tamanho certo e
conhecer os tipos de investimento mais comuns — com os riscos de cada um explicados com
clareza, pra você decidir com consciência. E-book digital com acesso imediato e garantia
incondicional de 7 dias. Conteúdo educacional: não é recomendação personalizada de
investimento nem promessa de rentabilidade.

**Name (EN):** Investing from Zero — NextLevel Practical Guide
**Description (EN):**
The step-by-step guide to go from zero to investor, without the jargon: get your budget and
debt in order before investing your first dollar, build an emergency fund of the right size
and understand the most common investment types — with the risks of each explained clearly, so
you can decide consciously. Digital ebook, instant access, 7-day unconditional guarantee.
Educational content: not personalized investment advice nor a promise of returns.

**Nombre (ES):** Inversiones desde Cero — Guía Práctica NextLevel
**Descripción (ES):**
El paso a paso para pasar de cero a inversor, sin tecnicismos: ordenar el presupuesto y las
deudas antes de invertir, crear un fondo de emergencia del tamaño correcto y conocer los tipos
de inversión más comunes — con los riesgos de cada uno explicados con claridad, para decidir
con conciencia. Ebook digital, acceso inmediato y garantía incondicional de 7 días. Contenido
educativo: no es asesoramiento personalizado ni promesa de rentabilidad.

---

## 4. Confiança Social — categoria: Desenvolvimento pessoal

**Nome (PT):** Confiança Social na Prática — Guia NextLevel
**Descrição (PT):**
Técnicas práticas de confiança e conversação pra você vencer a timidez e ficar à vontade em
qualquer situação social: trabalho, festas, encontros e novas amizades. Exercícios
progressivos pra sair da zona de conforto um passo de cada vez, como destravar e manter uma
boa conversa sem roteiro decorado, e presença autêntica — nada de manipulação ou fórmulas
falsas. E-book digital com acesso imediato e garantia incondicional de 7 dias. Conteúdo
educacional — não substitui acompanhamento psicológico.

**Name (EN):** Social Confidence in Practice — NextLevel Guide
**Description (EN):**
Practical confidence and conversation techniques to beat shyness and feel at ease in any
social situation: work, parties, dates and new friendships. Progressive exercises to leave
your comfort zone one step at a time, how to start and keep a good conversation without
memorized scripts, and authentic presence — no manipulation or fake formulas. Digital ebook,
instant access, 7-day unconditional guarantee. Educational content — not a substitute for
psychological care.

**Nombre (ES):** Confianza Social en la Práctica — Guía NextLevel
**Descripción (ES):**
Técnicas prácticas de confianza y conversación para superar la timidez y sentirte cómodo en
cualquier situación social: trabajo, fiestas, citas y nuevas amistades. Ejercicios progresivos
para salir de tu zona de confort un paso a la vez, cómo iniciar y mantener una buena
conversación sin guiones memorizados, y presencia auténtica — nada de manipulación ni fórmulas
falsas. Ebook digital, acceso inmediato y garantía incondicional de 7 días. Contenido
educativo — no sustituye el acompañamiento psicológico.

---

## 5. Comunicação e Relacionamentos — categoria: Desenvolvimento pessoal

**Nome (PT):** Comunicação e Relacionamentos — Guia NextLevel
**Descrição (PT):**
Aprenda a se comunicar com clareza e empatia pra construir relacionamentos saudáveis no amor,
na família, nas amizades e no trabalho. Assertividade sem grosseria, escuta ativa na prática —
a habilidade que mais transforma qualquer relação — e como discordar, pedir mudanças e
negociar sem magoar o outro nem se anular. Comunicação honesta, sem joguinhos. E-book digital
com acesso imediato e garantia incondicional de 7 dias. Conteúdo educacional — não substitui
acompanhamento psicológico.

**Name (EN):** Communication & Relationships — NextLevel Guide
**Description (EN):**
Learn to communicate with clarity and empathy to build healthy relationships in love, family,
friendships and work. Assertiveness without rudeness, active listening in practice — the skill
that most transforms any relationship — and how to disagree, ask for change and negotiate
without hurting the other person or erasing yourself. Honest communication, no games. Digital
ebook, instant access, 7-day unconditional guarantee. Educational content — not a substitute
for psychological care.

**Nombre (ES):** Comunicación y Relaciones — Guía NextLevel
**Descripción (ES):**
Aprende a comunicarte con claridad y empatía para construir relaciones sanas en el amor, la
familia, las amistades y el trabajo. Asertividad sin brusquedad, escucha activa en la práctica
— la habilidad que más transforma cualquier relación — y cómo discrepar, pedir cambios y
...
> ✅ **Cadastrado e ao vivo na Hotmart nas 3 moedas (jul/2026).** Checkout PT/BRL:
> `https://pay.hotmart.com/T106596501Y` — já colado em `produtos/suplementacao-inteligente/index.html`.
> Checkout ES/USD: `https://pay.hotmart.com/K106596585A` — já colado em `index-es.html`. Checkout
> EN/USD: `https://pay.hotmart.com/L106596626U` — já colado em `index-en.html`. **Preço final
> definido pelo dono do projeto: R$ 49,99 (PT) e US$ 19,00 (EN/ES)** — já salvo nas 3 páginas do
> site, no e-book gratuito/CTA e em `netlify/functions/lib/produtos-email.mjs`. `disponivel:
> true` em `assets/produtos.js`.
>
> Histórico: o produto EN tinha sido barrado pela Hotmart num primeiro momento ("non-compliance
> with Terms of Use", sem motivo exato — suspeita da palavra "steroids" na descrição disparando
> filtro automático). O dono do projeto reenviou **a versão antiga, sem alteração nenhuma, e ela
> foi aceita** — ou seja, a suspeita da palavra-gatilho não se confirmou; a reprovação inicial
> provavelmente foi falha pontual de moderação. Por precaução, o e-book pago e o gratuito em
> inglês continuam com a versão revisada (toda menção a "anabolic steroid(s)" trocada por
> "hormone(s)"/"banned substance(s)", mesmo sentido) — não houve necessidade de reverter, já que
> o conteúdo revisado é igualmente correto. A descrição original (com "steroids") e a revisada
> (sem a palavra) continuam ambas abaixo como referência.
...
2. Mandar pro Claude (ou editar direto): o link BRL vai no `linkCheckoutHotmart` do
   `produtos/<slug>/index.html`, o link USD vai nas versões `-en` e `-es`.
3. Quando o produto estiver com PDF entregável + checkout funcionando: trocar
   `disponivel: false` → `true` no `assets/produtos.js`.
